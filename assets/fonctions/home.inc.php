...
function postHtml($media, $commentaire, $idPost)
{
    ...
    echo '<p class="lead">' . $commentaire[0]["commentaire"] . '</p><a href="supprimer.php?idPost=' . $idPost . '">supprimer 🚮</a><a class="float-right" href="modifier.php?idPost=' . $idPost . '">modifier 🖋</a>';
    echo '</div></div></div>';
}
